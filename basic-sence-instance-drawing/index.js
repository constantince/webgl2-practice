...
function main() {
    ...
    const planeVerties = twgl.primitives.createCubeVertices(20);
    ...
    const sence = [
      ...
      {
        name: 'plane',
        verties: planeVerties,
        buffer: planeBufferInfo,
        vao: planeVao,
        init: function(time) {
          this.vao = twgl.createVAOFromBufferInfo(this.verties);
          const uniformsAndAttribs = this.calculateTheUniforms(time);
          // const instanceWorld = new Float32Array()
