...
function main() {
    ...
    const cubevao = twgl.createVAOFromBufferInfo(gl, programInfo, cubeBuffInfo);
    ...
    var tick = function(time) {
        ...
        let view = m4.lookAt([Math.cos(time * 0.0001) * 5, 4, Math.sin(time * 0.0001) * 5], [0, 0, 0], [0, 1, 0]);
        view = m4.inverse(view);
        const world = twgl.m4.scale(m4.identity(), [0.7, 1, 5.2]);
